...
Creative Commons Atribución/Reconocimiento-NoComercial-CompartirIgual
4.0 Licencia Pública Internacional — CC BY-NC-SA 4.0
...
Atribución/Reconocimiento-NoComercial-CompartirIgual 4.0 de Creative
Commons ("Licencia Pública"). En la medida en que esta Licencia Pública
pueda ser interpretada como un contrato, a Usted se le otorgan los
Derechos Licenciados en consideración a su aceptación de estos términos
y condiciones, y el Licenciante le concede a Usted tales derechos en
consideración a los beneficios que el Licenciante recibe por poner
a disposición el Material Licenciado bajo estos términos y condiciones.
...
Sección 1 -- Definiciones.
  ...
  b. Licencia de adaptador es aquella licencia que Usted aplica a Sus
     ...
     consideradas como Material Adaptado de acuerdo con los términos
     y condiciones de esta Licencia Pública.

  c. Una Licencia Compatible con BY-NC-SA es aquella que aparece en la
  ...
  d. Derechos de Autor y Derechos Similares son todos aquellos derechos
     ...
     las secciones 2(b)(1)-(2) no se consideran Derechos de Autor
  ...
  f. Excepciones y Limitaciones son el uso justo (fair use), el trato
     justo (fair dealing) y/o cualquier otra excepción o limitación
     a los Derechos de Autor y Derechos Similares que se apliquen al
     uso el Material Licenciado.

  g. Los Elementos de la Licencia son los atributos que figuran en el
     nombre de la Licencia Pública de Creative Commons. Los Elementos
     de la Licencia de esta Licencia Pública son
     Atribución/Reconocimiento, NoComercial y CompartirIgual.
  ...
  k. NoComercial, a los efectos de esta licencia, es que no se
     encuentre principalmente destinado o dirigido a obtener una
     ventaja comercial o una compensación monetaria. Para los
     propósitos de esta Licencia Pública, el intercambio de Material
     Licenciado por otro material sujeto a Derechos de Autor y Derechos
     Similares a través de mecanismos de intercambio de archivos
     digitales o de medios similares, se considerará como NoComercial
     siempre que no haya pago de una compensación monetaria en relación
     con el intercambio.

  l. Compartir significa proporcionar material al público por cualquier
     ...
     presentación pública, distribución, difusión, comunicación
     o importación, así como también su puesta a disposición,
     incluyendo formas en que el público pueda acceder al material
  ...
  n. Usted es el individuo o la entidad que ejerce los Derechos
...
Sección 2 -- Ámbito de Aplicación.
  ...
  a. Otorgamiento de la licencia.
       ...
       1. Sujeto a los términos y condiciones de esta Licencia Pública,
          ...
          global, gratuita, no transferible a terceros, no exclusiva
          e irrevocable para ejercer los Derechos Licenciados sobre el
          Material Licenciado para:

            a. reproducir y Compartir el Material Licenciado, en su
               totalidad o en parte, solamente para fines
               NoComerciales; y

            b. producir, reproducir y Compartir Material Adaptado
               solamente para fines NoComerciales.
       ...
       2. Excepciones y Limitaciones. Para evitar cualquier duda, donde
          ...
          no tendrá necesidad de cumplir con sus términos
          y condiciones.
       ...
       4. Medios y formatos; modificaciones técnicas permitidas. El
          ...
          necesarias para eludir las Medidas Tecnológicas Efectivas.
          A los efectos de esta Licencia Pública, la mera realización
          de modificaciones autorizadas por esta sección 2(a)(4) nunca
  ...
  b. Otros derechos.
       ...
       3. En la medida de lo posible, el Licenciante renuncia al
          ...
          cualquier derecho de cobrar esas regalías, incluidos aquellos
          casos en los que el Material Licenciado sea utilizado para
          fines distintos a los NoComerciales.
...
Bases de Datos que apliquen a Su uso del Material Licenciado:
  ...
  a. para evitar cualquier duda, la sección 2(a)(1) le concede a Usted
     el derecho a extraer, reutilizar, reproducir y Compartir todo
...
Sección 5 – Exención de Garantías y Limitación de Responsabilidad.
  ...
  a. SALVO QUE EL LICENCIANTE SE HAYA COMPROMETIDO MEDIANTE UN ACUERDO
     ...
     MATERIAL LICENCIADO, YA SEA DE MANERA EXPRESA, IMPLÍCITA, LEGAL
     U OTRA. ESTO INCLUYE, DE MANERA NO TAXATIVA, LAS GARANTÍAS DE
     ...
     TOTALMENTE O EN PARTE, LA DECLARACIÓN DE AUSENCIA DE GARANTÍAS,
  ...
  b. EN LA MEDIDA DE LO POSIBLE, EN NINGÚN CASO EL LICENCIANTE SERÁ
     ...
     LIMITACIÓN DE RESPONSABILIDAD, YA SEA TOTALMENTE O EN PARTE,
     A USTED PUEDE NO APLICÁRSELE ESTA LIMITACIÓN.
